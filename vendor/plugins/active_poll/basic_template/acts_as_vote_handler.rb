  ...
  public
    ...
    def ap_vote_registered
      ...
      unless xxUSER_MODELxx_id.blank?
        xxUSER_MODELxx = xxUSER_MODELxx_cap.find(xxUSER_MODELxx_id) unless xxUSER_MODELxx_id.blank?
      else
        salt = poll_name
      ...
      if poll_name.nil?
        ...
        ActivePollAnswer.transaction do
          ...
          answers.each {
            ...
            user_answer.xxUSER_MODELxx = xxUSER_MODELxx if poll.target == ActivePollHelper::TARGET_LOGGED_USER || poll.target == ActivePollHelper::TARGET_BOTH && !xxUSER_MODELxx_id.blank?
