...
ActivePollQuestion.transaction do
  ar_question = ActivePollQuestion.new :name => poll_name, :description => question
  ...
  answers.each { |answer|
    ar_answer = ActivePollAnswer.new :description => answer
    ar_answer.active_poll_question = ar_question
    ar_answer.save!
  }
end
